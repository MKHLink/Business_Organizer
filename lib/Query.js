...
class Query
{
    //this function displayes the ui in the terminal for the user
    userUI(){
    ...
    //function to get all the departemts
    getDepartments()
    {
    ...
    //function to get all the roles and their departments
    getRoles()
    {
    ...
    //function to get all the employees and their correspodning managers, departments and roles
    getEmployees()
    {
    ...
    //function to get all the employees under a manager
    employeeByManager()
    {
        inquirer
        .prompt([
    ...
    //function to get all the employees in a department
